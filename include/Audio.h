...
namespace Audio
{
    inline Sound playingSounds[10];
    inline int playingSoundsCount = 0;

    inline SoundClip loadSoundClip(const char* filePath)
    {
    ...
    inline Sound* AddSound(float amplitude, float frequency, float amplitudeFactor, float frequencyFactor, bool looping)
    {
    ...
    inline Sound* PlaySoundClip(SoundClip soundClip, float amplitude, float frequency, float amplitudeFactor, float frequencyFactor, bool looping)
    {
    ...
    inline Sound* PlaySound(float amplitude, float frequency, float amplitudeFactor, float frequencyFactor, bool looping)
    {
    ...
    inline void AudioCallback(float* buffer, int numFrames, int numChannels)
    {

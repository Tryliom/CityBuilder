...
clang++ -o bin/game.exe bin/Game.lib -g bin/obj/Engine.o bin/obj/Image.o bin/obj/Input.o bin/obj/Timer.o bin/obj/imgui_demo.o bin/obj/imgui_draw.o bin/obj/imgui_tables.o bin/obj/imgui_widgets.o bin/obj/imgui.o
